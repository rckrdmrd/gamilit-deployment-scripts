...
--
-- Name: leaderboard_metadata; Type: TABLE; Schema: gamification_system; Owner: gamilit_user
--
...
ALTER TABLE gamification_system.leaderboard_metadata OWNER TO gamilit_user;

--
-- Name: TABLE leaderboard_metadata; Type: COMMENT; Schema: gamification_system; Owner: gamilit_user
--
...
--
-- Name: leaderboard_metadata leaderboard_metadata_pkey; Type: CONSTRAINT; Schema: gamification_system; Owner: gamilit_user
--
