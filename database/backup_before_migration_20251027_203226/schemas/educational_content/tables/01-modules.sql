...
CREATE TABLE educational_content.modules (
    ...
    rango_maya_required public.rango_maya,
    rango_maya_granted public.rango_maya,
...
CREATE INDEX idx_modules_rango_required ON educational_content.modules USING btree (rango_maya_required);
...
-- Permissions
GRANT ALL ON TABLE educational_content.modules TO glit_user;
